...
<pre><code class="hljs"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;https://cdnjs.cloudflare.com/ajax/libs/tocbot/4.18.2/tocbot.min.js&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre><h3 id="include-css">Include CSS</h3>
<p>CSS is used for expanding &amp; collapsing groupings and some basic styling.</p>
<pre><code class="hljs"><span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">&quot;stylesheet&quot;</span> <span class="hljs-attr">href</span>=<span class="hljs-string">&quot;https://cdnjs.cloudflare.com/ajax/libs/tocbot/4.18.2/tocbot.css&quot;</span>&gt;</span></code></pre><p>OR</p>
...
<span class="hljs-attr">disableTocScrollSync</span>: <span class="hljs-literal">false</span>,
<span class="hljs-comment">// Offset for the toc scroll (top) position when scrolling the page.</span>
<span class="hljs-comment">// Only effective if `disableTocScrollSync` is false.</span>
<span class="hljs-attr">tocScrollOffset</span>: <span class="hljs-number">0</span>,</code></pre><h3 id="methods">Methods</h3>
<h4 id="init">.init</h4>
...
</script></div></main></div></div><script id="__NEXT_DATA__" type="application/json">{"props":{"pageProps":{}},"page":"/","query":{},"buildId":"qqlQ8ZGnvDRpOQwvL3usu","assetPrefix":"/tocbot","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}</script></body></html>